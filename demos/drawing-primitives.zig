...
pub fn main() uefi.Status {
    ...
    drawing.bitmapFill(screen, utils.Colors.green.argb);
    ...
    drawing.bitmapFill(bitmap, utils.Colors.white.argb);

    // Render string to bitmap
    _ = utils.renderString(bitmap, 0, 0, utils.Colors.transparent.argb, utils.Colors.black.argb, 16, "abc!");

    // Draw line to bitmap
    drawing.drawLineWidth(bitmap, 3, 3, 30, 30, utils.Colors.red.argb, 1);
    ...
    // Draw box directly to screen
    drawing.drawBox(screen, 30, 20, 100, 150, utils.Colors.red.argb, 1);
    drawing.drawBox(screen, 70, 40, 100, 150, utils.Colors.red.argb, 4);

    // Draw circle directly to screen
    drawing.drawBox(screen, 60, 60, 100, 50, utils.Colors.black.argb, 1);
    drawing.drawCircle(screen, 60, 60, 100, 50, utils.Colors.blue.argb);
