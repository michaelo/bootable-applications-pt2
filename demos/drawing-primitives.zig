...
pub fn main() uefi.Status {
    ...
    drawing.bitmapFill(screen, drawing.Colors.green);
    ...
    drawing.bitmapFill(bitmap, drawing.Colors.white);

    // Render string to bitmap
    _ = drawing.drawString(bitmap, 0, 0, drawing.Colors.transparent, drawing.Colors.black, 16, "abc!");
    ...
    drawing.drawBox(screen, 30, 20, 100, 150, drawing.Colors.red, 1);
    drawing.drawBox(screen, 70, 40, 100, 150, drawing.Colors.red, 4);

    // Draw circle directly to screen
    drawing.drawBox(screen, 60, 60, 100, 50, drawing.Colors.black, 1);
    drawing.drawCircle(screen, 60, 60, 100, 50, drawing.Colors.blue);
