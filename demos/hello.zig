...
pub fn main() std.os.uefi.Status {
    // system_table.con_out is a convenience-reference to a
    // EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL instance (if found)
    ...
    // UEFI works with wide (UTF-16) strings, (stdlib has convenient functions to
    // convert UTF8->UTF16)
